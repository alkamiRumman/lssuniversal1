...
<head>
	...
	<link rel="stylesheet"
		  href="<?= base_url('assets/adminLte/bower_components/datatables.net/css/datatable.min.css') ?>">
	<link rel="stylesheet"
		  href="<?= base_url('assets/adminLte/bower_components/datatables.net/css/jquery.dataTables.min.css') ?>">
	<!--	<link rel="stylesheet" href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css">-->
	<link rel="stylesheet"
		  href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
	<link rel="stylesheet" href="<?= base_url('assets/adminLte/dist/css/bootstrap-select.min.css') ?>">
	<!--	<link rel="stylesheet" href="http://demo.itsolutionstuff.com/plugin/bootstrap-3.min.css">-->
	<link href="<?= base_url('assets/adminLte/plugins/drag-drop-image-uploader/dist/image-uploader.min.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/datatable/css/jquery.dataTables.yadcf.css') ?>" rel="stylesheet">
