...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form role="form" action="<?= admin_url('saveVenue') ?>" method="post" autocomplete="off"
									...
									<div class="repeat">
										<div class="repeatBox0">
											<div class="row">
												...
												<div class="form-group col-md-3">
													<label for="pocPhone"> Phone Number <b class="text-danger">*</b></label>
													<input class="form-control input-sm" type="tel" name="pocPhone[]" id="pocPhone"
														   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
														   maxlength="10" minlength="10" pattern="[0-9]{10}" title="Must be 10 numbers" placeholder="Enter Phone Number" required>
												</div>
												<div class="form-group col-md-2">
...
<script>
	...
	$(function () {
		...
		$('.add').on('click', function (e) {
			...
			var repeat = '<div class="repeatBox' + id_count + '">' +
				...
				'<input class="form-control input-sm" type="tel" name="pocPhone[]"' +
	...
	window.onload = function () {
		Table = $('#item-list').DataTable({
			...
			'bServerSide': true,
			'sAjaxSource': '<?= admin_url('getVenues') ?>',
	...
	$('#item-list tbody').on('click', 'tr td', function () {
		...
		switch (columnIndex) {
			...
			case 8:
				break;
			default:
				loadPopup('<?= admin_url('viewVenue/') ?>' + data.id);
				break;
		}
	});
</script>
