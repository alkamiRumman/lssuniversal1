	...
	<div class="modal-dialog modal-lg" style="width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Update Talent & Crew Travel Details</b></h4>
			</div>
			<form id="formEdit" action="<?= admin_url('updateRunOfShowTalentCrew/') . $data->id ?>" method="post">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-default">
								<label for="title" class="control-label">
									Talent & Crew Travel Details</label>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="form-group col-md-3">
											<label for="airportToAccommodation">Airport To</label><br>
											<select class="form-control input-sm" name="airportToAccommodation"
													style="width: 100%"
													id="airportToAccommodation">
												<option value="">Select Airline To</option>
												<!-- Alabama -->
												<optgroup label="Alabama - AL">
													<option value="Birmingham International Airport - BHM">Birmingham
											...
											<input type="hidden" id="airportToAccommodationVal" value="<?= $data->airportToAccommodation ?>">
										</div>
										<div class="form-group col-md-3">
...
<script>
	...
	var airportToAccommodationVal = $('#airportToAccommodationVal').val();
	...
	$('#airportToAccommodation').val(airportToAccommodationVal).trigger("change");
	...
	$(function () {
		$("#crewMemberId").select2({
			...
			ajax: {
				url: '<?= admin_url("getTalentCrewMemberSearch/") . $data->productionId ?>',
				dataType: 'json',
				type: "POST",
				quietMillis: 50,
				allowClear: true,
			...
			$('#airportToAccommodation').val(data.airlineTo).trigger('change');
	...
	$('#airportFromFrom, #airportFromTo, #airportToFrom, #airportToTo, #airportToAccommodation').select2({
		dropdownParent: $('#remoteModal1')
	});
