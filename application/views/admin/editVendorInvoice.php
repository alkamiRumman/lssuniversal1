<div class="modal fade in" id="modal-default" style="display: block; overflow: auto;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form id="formEdit" action="<?= admin_url('updateVendorInvoice/') . $data->id ?>" method="post"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select id="vendorId" name="vendorId" class="form-control selectVendor"
										...
										<option selected value="<?= $data->vendorId ?>"><?= $data->name ?></option>
									</select>
								</div>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<select class="form-control" name="net" id="net">
											<option <?= $data->net == 30 ? 'selected' : '' ?> value="30">30</option>
											<option <?= $data->net == 60 ? 'selected' : '' ?> value="60">60</option>
											<option <?= $data->net == 90 ? 'selected' : '' ?> value="90">90</option>
										</select>
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<div class="input-group date">
											...
											<input type="text" class="form-control" name="dueDate" id="dueDate"
												   value="<?= date('d M Y', strtotime($data->dueDate)) ?>" required>
										</div>
									</div>
								</div>
							</div>
