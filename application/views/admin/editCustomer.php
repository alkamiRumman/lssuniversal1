						...
						<div class="vendorDetailsEdit" <?= $data->type == 'Customer' || $data->type == 'Admin' ? 'style="display: none"' : '' ?>>
							<div class="form-group col-md-6">
								...
								<input class="form-control" type="text" name="businessName" id="businessNameEdit"
									   placeholder="Enter Business Name" value="<?= $data->businessName ?>">
							</div>
							<div class="form-group col-md-6">
								...
								<input class="form-control" type="number" min="0" step="1" maxlength="9" name="ein"
									   ...
									   placeholder="Enter EIN" value="<?= $data->ein ?>">
							</div>
							<div class="form-group col-md-6">
							...
							<div class="form-group col-md-6">
								<label for="service1Edit">Services 1</label>
								<select id="service1Edit" name="service1" class="form-control" disabled>
...
<script>
	...
	$('#typeEdit').on('change', function () {
		var type = $('#typeEdit').find(":selected").val();
		if (type == 'Customer') {
			$('.vendorDetailsEdit').hide();
			$('#businessNameEdit').attr("required", false);
			$('#einEdit').attr("required", false);
			$('#businessAddressEdit').attr("required", false);
			$('#cityEdit').attr("required", false);
			$('#stateEdit').attr("required", false);
		} else {
			$('.vendorDetailsEdit').show();
			$('#businessNameEdit').attr("required", true);
			$('#einEdit').attr("required", true);
			$('#businessAddressEdit').attr("required", true);
			$('#cityEdit').attr("required", true);
			$('#stateEdit').attr("required", true);
		}
	})
