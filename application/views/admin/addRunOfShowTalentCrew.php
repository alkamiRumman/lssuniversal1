	...
	<div class="modal-dialog modal-lg" style="width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Add Talent & Crew Travel Details</b></h4>
			</div>
			<form id="formEdit" action="<?= admin_url('saveRunOfShowTalentCrew/') . $id ?>" method="post">
...
<script>
	...
	$(function () {
		$("#crewMemberId").select2({
			placeholder: "Select Talent Crew Member",
			dropdownParent: $('#remoteModal1'),
			ajax: {
				url: '<?= admin_url("getTalentCrewMemberSearch/") . $id ?>',
				dataType: 'json',
				type: "POST",
				quietMillis: 50,
				allowClear: true,
