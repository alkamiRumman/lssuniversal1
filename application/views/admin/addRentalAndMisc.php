	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Add Rental & Misc Fee</b></h4>
			</div>
			<form id="formEdit" action="<?= admin_url('saveRentalAndMisc/') . $id ?>" method="post">
	...
	$('#formEdit').on('submit', function (e) {
		...
		$.ajax({
			...
			success: function (data) {
				...
				$("#rentalAndMiscTableDiv").load(window.location + " #rentalAndMiscTableDiv > *");
				setTimeout(function () {
					calculateCosts();
				}, 1000);
