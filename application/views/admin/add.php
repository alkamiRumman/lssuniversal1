							...
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= admin_url('addCrewMember/') . $id ?>')"
						...
						<div class="col-md-12">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= admin_url('addEntertainer/') . $id ?>')"
						...
						<div class="col-md-12">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= admin_url('addTheatreCrew/') . $id ?>')"
						...
						<div class="col-md-6">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= admin_url('addMarketingFee/') . $id ?>')"
									   class="btn btn-sm pull-right"><i class="fa fa-plus"></i> Add New</a>
								</div>
								<div class="box-body">
									<div class="table-responsive" style="overflow: auto;">
						...
						<div class="col-md-6">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= admin_url('addRentalAndMisc/') . $id ?>')"
									   class="btn btn-sm pull-right"><i class="fa fa-plus"></i> Add New</a>
								</div>
								<div class="box-body">
