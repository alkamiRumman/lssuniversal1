	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Add Ticket Tiering</b></h4>
			</div>
			<form id="formEdit" action="<?= admin_url('saveTicketTiering/') . $id ?>" method="post">
				<div class="modal-body">
					...
					<div class="row">
						<div class="form-group col-md-4">
							...
							<input class="form-control input-sm" type="number"
								   step="1" min="0" name="ofSeats" id="ofSeats">
						</div>
						<div class="form-group col-md-4">
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<input class="form-control input-sm"
								   type="number" step="any" min="0" name="roi"
								   id="roi" readonly>
						</div>
						<div class="col-md-2">
							<label for="comp">COMP </label><br>
							<input id="comp" type="checkbox" value="1" name="comp"
