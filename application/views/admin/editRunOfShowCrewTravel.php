<div class="modal fade in" id="modal-default" style="display: block;overflow: auto;">
	<div class="modal-dialog modal-lg" style="width: 90%">
		<div class="modal-content">
			...
			<form id="formEdit" action="<?= admin_url('updateRunOfShowCrewTravel/') . $data->id ?>" method="post">
								...
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="form-group col-md-3">
											...
											<input type="hidden" id="airportToAccommodationVal"
												   value="<?= $data->airportToAccommodation ?>">
										</div>
										<div class="form-group col-md-3">
...
<script>
	...
	$(function () {
		$("#crewMemberId").select2({
			...
			ajax: {
				url: '<?= admin_url("getCrewMemberSearch/") . $data->productionId ?>',
				dataType: 'json',
				type: "POST",
				quietMillis: 50,
				allowClear: true,
