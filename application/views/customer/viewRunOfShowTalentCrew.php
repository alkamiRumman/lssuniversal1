					...
					<div class="col-md-12">
						<div class="box box-default" style="background-color: #D3D3D3">
							<div class="box-header with-border"
								...
								<h3 class="box-title" style="font-size: 14px"><b>Talent & Crew Travel Details</b></h3>
								<?php if ($data->archivesStatus == 0) { ?>
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addRunOfShowTalentCrew/') . $data->id ?>')"
															...
															<div class="dropdown">
																...
																<ul class="dropdown-menu">
																	<li><a href="javascript:void(0);"
																		   onclick="loadPopup('<?= base_url('customer/editRunOfShowTalentCrew/' . $crewTravelDetail->id) ?>')">Edit</a>
																	</li>
																	<li>
																		<a href="<?= base_url('customer/deleteRunOfShowTalentCrew/' . $crewTravelDetail->id) ?>"
