	...
	<div class="modal-dialog" style="width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Update Entertainer Details</b></h4>
			</div>
			<form id="formEdit" action="<?= customer_url('updateEntertainer/') . $data->id ?>" method="post">
				<div class="modal-body">
					<div class="row">
						<div class="form-group col-md-2">
							<label for="firstName">First Name <span class="text-danger">*</span></label>
							<input class="form-control input-sm" type="text" name="firstName"
								   id="firstName" value="<?= $data->firstName ?>" required>
						</div>
						<div class="form-group col-md-2">
						...
						<div class="form-group col-md-2">
							...
							<input class="form-control input-sm" type="text" name="role"
								   id="role" value="<?= $data->role ?>" required>
						</div>
						<div class="form-group col-md-2">
							<label for="bookingFee">Booking Fee <span class="text-danger">*</span></label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="bookingFee"
									   id="bookingFee" value="<?= $data->bookingFee ?>" required>
							</div>
						</div>
						<div class="form-group col-md-2">
							<label for="hotelName">Hotel Name </label>
							<input class="form-control input-sm" type="text" name="hotelName"
								   id="hotelName" value="<?= $data->hotelName ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="hotelNightlyRateEdit">Hotel Nightly Rate </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="hotelNightlyRate"
									   id="hotelNightlyRateEdit" value="<?= $data->hotelNightlyRate ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-2">
							<label for="totalNightEdit">Hotel Stay (Total Nights) </label>
							<input class="form-control input-sm" type="number"
								   onkeydown="if(event.key==='.'){event.preventDefault();}"
								   step="1" min="0" name="totalNight"
								   id="totalNightEdit" value="<?= $data->totalNight ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="perDiemEdit">Per Diem </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="perDiem"
									   id="perDiemEdit" value="<?= $data->perDiem ?>">
							</div>
						</div>
						<div class="form-group col-md-2">
							...
							<select class="form-control input-sm" name="airline"
								...
								<option <?= $data->airline == "Alaska Airlines" ? 'selected' : '' ?>
										value="Alaska Airlines">Alaska Airlines
								</option>
								<option <?= $data->airline == "Allegiant Air" ? 'selected' : '' ?>
										value="Allegiant Air">
									Allegiant Air
								</option>
								<option <?= $data->airline == "American Airlines" ? 'selected' : '' ?>
										value="American Airlines">American Airlines
								</option>
								<option <?= $data->airline == "Breeze Airways" ? 'selected' : '' ?>
										value="Breeze Airways">Breeze Airways
								</option>
								<option <?= $data->airline == "Delta Air" ? 'selected' : '' ?>
										value="Delta Air Lines">Delta Air Lines
								</option>
								<option <?= $data->airline == "Frontier Airlines" ? 'selected' : '' ?>
										value="Frontier Airlines">Frontier Airlines
								</option>
								<option <?= $data->airline == "Hawaiian Airlines" ? 'selected' : '' ?>
										value="Hawaiian Airlines">Hawaiian Airlines
								</option>
								<option <?= $data->airline == "JetBlue" ? 'selected' : '' ?>
										value="JetBlue">JetBlue
								</option>
								<option <?= $data->airline == "Southwest Airlines" ? 'selected' : '' ?>
										value="Southwest Airlines">Southwest Airlines
								</option>
								<option <?= $data->airline == "Spirit Airlines" ? 'selected' : '' ?>
										value="Spirit Airlines">Spirit Airlines
								</option>
								<option <?= $data->airline == "Sun Country" ? 'selected' : '' ?>
										value="Sun Country Airlines">Sun Country Airlines
								</option>
								<option <?= $data->airline == "United Airlines" ? 'selected' : '' ?>
										value="United Airlines">United Airlines
								</option>
							</select>
						</div>
						<div class="form-group col-md-2">
							<label for="airlineFrom">Airline From</label>
							...
							<input type="hidden" id="airlineFromVal" value="<?= $data->airlineFrom ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="airlineTo">Airline To</label>
							<select class="form-control input-sm" id="airlineTo" name="airlineTo" style="width: 100%"
									id="airlineFrom">
					...
					<div class="row">
						<div class="form-group col-md-2">
							...
							<select class="form-control input-sm" name="rountTrip" id="rountTrip">
								<option <?= $data->rountTrip == 'Yes' ? 'selected' : '' ?> value="Yes">Yes</option>
								<option <?= $data->rountTrip == 'No' ? 'selected' : '' ?> value="No">No</option>
							</select>
						</div>
						<div class="form-group col-md-2">
							<label for="ticketCostEdit">Airline Ticket Cost </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="ticketCost"
									   id="ticketCostEdit" value="<?= $data->ticketCost ?>">
							</div>
						</div>
						<div class="form-group col-md-2">
							<label for="groundTransCo">Ground Trans Co.</label>
							<input class="form-control input-sm" type="text" name="groundTransCo"
								   id="groundTransCo" value="<?= $data->groundTransCo ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="groundTransCostEdit">Ground Trans Cost </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="groundTransCost"
									   id="groundTransCostEdit" value="<?= $data->groundTransCost ?>">
							</div>
						</div>
						<div class="form-group col-md-2">
							<label for="miscFeeEdit">Misc. Fee </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="miscFee"
									   id="miscFeeEdit" value="<?= $data->miscFee ?>">
							</div>
						</div>
						<div class="form-group col-md-2">
							<label for="riderFeeEdit">Rider Fee </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="riderFee"
									   id="riderFeeEdit" value="<?= $data->riderFee ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-3">
							<label for="entertainerNotes">Notes</label>
							<input class="form-control input-sm" type="text" name="entertainerNotes"
								   id="entertainerNotes" value="<?= $data->entertainerNotes ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="entertainerCostEdit">Total Cost</label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="entertainerCost"
									   id="entertainerCostEdit" value="<?= $data->entertainerCost ?>" readonly>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	var airlineFrom = $('#airlineFromVal').val();
	var airlineTo = $('#airlineToVal').val();
	$('#airlineFrom').val(airlineFrom).trigger("change");
	$('#airlineTo').val(airlineTo).trigger("change");

	$('#bookingFee, #hotelNightlyRateEdit, #totalNightEdit, #perDiemEdit, #ticketCostEdit, #groundTransCostEdit, #miscFeeEdit, #riderFeeEdit').on('input', function () {
		var abookingFee = parseFloat($('#bookingFee').val()) || 0;
		var hotelNightlyRate = parseFloat($('#hotelNightlyRateEdit').val()) || 0;
		var totalNight = parseInt($('#totalNightEdit').val()) || 0;
		var perDiem = parseFloat($('#perDiemEdit').val()) || 0;
		var ticketCost = parseFloat($('#ticketCostEdit').val()) || 0;
		var groundTransCost = parseFloat($('#groundTransCostEdit').val()) || 0;
		var miscFee = parseFloat($('#miscFeeEdit').val()) || 0;
		var riderFee = parseFloat($('#riderFeeEdit').val()) || 0;
		var total = abookingFee + (hotelNightlyRate * totalNight) + (perDiem * totalNight) + ticketCost + groundTransCost + miscFee + riderFee;
		$('#entertainerCostEdit').val(total.toFixed(2));
	});
