	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"><b>Create New Production</b></h3>
			</div>
							...
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addCrewMember/') . $id ?>')"
						...
						<div class="col-md-12">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addEntertainer/') . $id ?>')"
						...
						<div class="col-md-12">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addTheatreCrew/') . $id ?>')"
						...
						<div class="col-md-6">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addMarketingFee/') . $id ?>')"
									   class="btn btn-sm pull-right"><i class="fa fa-plus"></i> Add New</a>
								</div>
								<div class="box-body">
									<div class="table-responsive" style="overflow: auto;">
						...
						<div class="col-md-6">
							<div class="box box-default" style="background-color: #D3D3D3">
								<div class="box-header with-border">
									...
									<a href="javascript:void(0);" style="background-color: #2D2D2D; color: white"
									   onclick="loadPopup('<?= customer_url('addRentalAndMisc/') . $id ?>')"
									   class="btn btn-sm pull-right"><i class="fa fa-plus"></i> Add New</a>
								</div>
								<div class="box-body">
									<div class="table-responsive" id="rentalAndMiscTableDiv" style="overflow: auto;">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<button type="submit" value="submit" class="btn"
									style="color: white;background-color: black">Save Production
							</button>
							<button type="submit" value="saveProgress" class="btn"
									style="color: white; background-color: #0081CE">Save Progress
							</button>
						</div>
					</div>
				</div>
...
<script>
	...
	$('#form').on('submit', function (e) {
		...
		if (clickedButton == 'submit') {
			...
			if (r == true) {
				actionUrl = '<?= customer_url('save') ?>';
			}
		} else {
			actionUrl = '<?= customer_url('saveProgress') ?>';
		}
