	...
	<div class="modal-dialog modal-lg" style="width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Add Entertainer</b></h4>
			</div>
			<form id="formEdit" action="<?= customer_url('saveEntertainer/') . $id ?>" method="post">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-2">
							<label for="riderFee">Rider Fee </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
					...
					<div class="row">
						...
						<div class="form-group col-md-2">
							<label for="entertainerCost">Total Cost</label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="entertainerCost"
									   id="entertainerCost" readonly>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	$('#bookingFee, #hotelNightlyRate, #totalNight, #perDiem, #ticketCost, #groundTransCost, #miscFee, #riderFee').on('input', function () {
		...
		var riderFee = parseFloat($('#riderFee').val()) || 0;
		var total = bookingFee + (hotelNightlyRate * totalNight) + (perDiem * totalNight) + ticketCost + groundTransCost + miscFee + riderFee;
		$('#entertainerCost').val(total.toFixed(2));
	});
