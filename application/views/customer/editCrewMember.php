	...
	<div class="modal-dialog" style="width: 90%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Update Crew Member Details</b></h4>
			</div>
			<form id="formEdit" action="<?= customer_url('updateCrewMember/') . $data->id ?>" method="post">
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-md-2">
							<label for="rateEdit">Rate <span class="text-danger">*</span></label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="rate"
									   id="rateEdit" value="<?= $data->rate ?>" required>
							</div>
						</div>
						<div class="form-group col-md-2">
					...
					<div class="row">
						...
						<div class="form-group col-md-2">
							<label for="equipmentRentalEdit">Equipment Rental </label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="equipmentRental"
									   id="equipmentRentalEdit" value="<?= $data->equipmentRental ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-3">
							...
							<input class="form-control input-sm" type="text" name="crewNotes"
								   id="crewNotes" value="<?= $data->crewNotes ?>">
						</div>
						<div class="form-group col-md-2">
							<label for="crewCostEdit">Total Cost</label>
							<div class="input-group">
								<span class="input-group-addon">$</span>
								<input class="form-control input-sm"
									   type="number" step="any" min="0" name="crewCost"
									   id="crewCostEdit" value="<?= $data->crewCost ?>" readonly>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	$('#rateEdit, #hotelNightlyRateEdit, #totalNightEdit, #perDiemEdit, #ticketCostEdit, #groundTransCostEdit, #miscFeeEdit, #equipmentRentalEdit').on('input', function () {
		var rate = parseFloat($('#rateEdit').val()) || 0;
