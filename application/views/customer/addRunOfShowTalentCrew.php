<div class="modal fade in" id="modal-default" style="display: block;overflow: auto;">
	<div class="modal-dialog modal-lg" style="width: 90%">
		<div class="modal-content">
			...
			<form id="formEdit" action="<?= customer_url('saveRunOfShowTalentCrew/') . $runOfShowDetails->id ?>"
				  method="post">
...
<script>
	...
	$(function () {
		$("#crewMemberId").select2({
			...
			ajax: {
				url: '<?= customer_url("getTalentCrewMemberSearch/") . $runOfShowDetails->productionId ?>',
				dataType: 'json',
				type: "POST",
				quietMillis: 50,
				allowClear: true,
